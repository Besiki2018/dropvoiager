    ...
    <div class="col-12">
      <div class="form-input" style="position: relative;">
          ...
          <i id="togglePassword" class="fa fa-eye"
             style="position:absolute; right:10px; top:50%; transform:translateY(-50%); cursor:pointer; color:#000;">
          </i>
      </div>
    </div>
        ...
        <div class="advanced y-gap-20">
            <div class="col-12">
                ...
                <?php if(setting_item('google_enable')): ?>
                    <a href="<?php echo e(url('social-login/google')); ?>" class="button col-12 -outline-red-1 py-15 rounded-8 mt-15 cursor-pointer" data-channel="google">
...
document.getElementById('togglePassword').addEventListener('click', function () {
    ...
    // აიქონის შეცვლა fa-eye ↔ fa-eye-slash
    this.classList.toggle('fa-eye');
    this.classList.toggle('fa-eye-slash');
});
</script>
<?php /**PATH /home/u618310530/domains/dropvoyage.com/public_html/themes/GoTrip/Layout/auth/login-form.blade.php ENDPATH**/ ?>