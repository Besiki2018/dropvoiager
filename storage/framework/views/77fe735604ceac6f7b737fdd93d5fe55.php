...
<head>
    ...
    <link href="<?php echo e(asset('themes/gotrip/css/vendors.css')); ?>" rel="stylesheet">
     ...
     <link href="<?php echo e(asset('css/customapp.css')); ?>" rel="stylesheet">
    ...
    <link href="<?php echo e(asset('themes/gotrip/css/tbccontractica-caps.css')); ?>" rel="stylesheet">
...
<style>
  ...
  .form-checkbox input.is-invalid + .form-checkbox__mark {
...
<?php /**PATH /Users/besikiekseulidze/web-development/dropvoyage/themes/GoTrip/Layout/app.blade.php ENDPATH**/ ?>