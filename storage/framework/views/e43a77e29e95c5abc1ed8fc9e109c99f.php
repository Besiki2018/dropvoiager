            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right">
                        <?php echo e(date('Y')); ?> &copy; Giorgi Paris <a
                            href="<?php echo e(__('https://bestweb.ge/')); ?>" target="_blank"
                        >Best Web</a>
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="<?php echo e(__('https://bestweb.ge/')); ?>" target="_blank"><?php echo e(__('About Us')); ?></a>
                            <a href="<?php echo e(__('https://bestweb.ge/')); ?>" target="_blank"><?php echo e(__('Contact Us')); ?></a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH /home/u618310530/domains/dropvoyage.com/public_html/modules/Layout/admin/app.blade.php ENDPATH**/ ?>