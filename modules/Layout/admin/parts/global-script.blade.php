@php
    $bookingAdminMapKey = setting_item('map_gmap_key');
    if (empty($bookingAdminMapKey)) {
        $bookingAdminMapKey = config('services.google.maps_api_key');
    }
@endphp
<script>
    var bookingCore = {
        ...
        map_gmap_key: '{{ $bookingAdminMapKey }}',
        csrf: '{{csrf_token()}}',
